...
<div class="m-subheader">
	<div class="d-flex align-items-center">
		<div class="mr-auto">
			<h3 class="m-subheader__title">Inquiries</h3>
		</div>
	</div>
</div>
<!-- END: Subheader -->
...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet__body">
			...
			<form class="m-form m-form--fit m--margin-bottom-20">
				<div class="row m--margin-bottom-20">
					<div class="col-lg-3 m--margin-bottom-10-tablet-and-mobile">
						{{ Form::select('status', collect(['N' => 'Pending', 'Y' => 'Contacted'])->prepend('Select status', ''), null, array('class' => 'form-control m-input filter_status')) }}
					</div>
			...
			<button class="btn btn-danger" id="mass-delete" data-url="{{route('backend.inquiries.mass-delete')}}">Mass Delete</button>
			<!--end: Datatable -->
		</div>	
	</div>
	<!--end::Portlet-->
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#m_table_1').DataTable({
			...
			serverSide: true,
			ajax:{
				url:"{{ route('backend.inquiries.index') }}",
				data: function (d) {
		...
		/* Change status */
		$(document).on('click', '.mark-contacted', function (e) {
			var url = $(this).data('url');

			swal({ 
				title: "Are you sure?",
				text: "Do you want to mark contacted this inquiry!",
				type: "warning",
