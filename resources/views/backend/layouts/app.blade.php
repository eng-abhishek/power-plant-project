													...
													<div class="m-dropdown__content">
														<ul class="m-nav m-nav--skin-light">
															...
															<li class="m-nav__item">
																<a href="{{route('superadmin.account.profile.view')}}" class="m-nav__link">
																	<i class="m-nav__link-icon flaticon-profile-1"></i>
																	<span class="m-nav__link-text">My Profile</span>
																</a>
															</li>
															<li class="m-nav__item">
																<a href="{{route('superadmin.account.change-password.view')}}" class="m-nav__link">
															...
															<li class="m-nav__item">
																<a href="{{ route('superadmin.logout') }}" class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
															</li>
			...
			<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark">
				...
				<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark" m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
					<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow">
						...
						<li class="m-menu__item {{(Route::currentRouteName() == 'superadmin.dashboard')?'m-menu__item--active':''}}" aria-haspopup="true">
							<a href="{{route('superadmin.dashboard')}}" class="m-menu__link ">
						...
						<li class="m-menu__item {{in_array(Route::currentRouteName(), ['superadmin.user.index','superadmin.user.create','superadmin.user.edit'])?'m-menu__item--active':''}}" aria-haspopup="true">
							<a href="{{route('superadmin.user.index')}}" class="m-menu__link ">
								<i class="m-menu__link-icon flaticon-dashboard"></i>
								<span class="m-menu__link-title">
									<span class="m-menu__link-wrap">
						...
						<li class="m-menu__item {{in_array(Route::currentRouteName(), ['superadmin.powerplant.index','superadmin.powerplant.create','superadmin.powerplant.edit'])?'m-menu__item--active':''}}" aria-haspopup="true">
							<a href="{{route('superadmin.powerplant.index')}}" class="m-menu__link ">
								<i class="m-menu__link-icon flaticon-dashboard"></i>
								<span class="m-menu__link-title">
									<span class="m-menu__link-wrap">
										<span class="m-menu__link-text">Power Plant</span>
									</span>
								</span>
							</a>
						</li>

						<li class="m-menu__item {{in_array(Route::currentRouteName(), ['superadmin.schedule.index','superadmin.schedule.create','superadmin.schedule.edit'])?'m-menu__item--active':''}}" aria-haspopup="true">
							<a href="{{route('superadmin.schedule.index')}}" class="m-menu__link ">
								<i class="m-menu__link-icon flaticon-dashboard"></i>
								<span class="m-menu__link-title">
									<span class="m-menu__link-wrap">
						...
						<li class="m-menu__item {{in_array(Route::currentRouteName(), ['superadmin.schedule-graph'])?'m-menu__item--active':''}}" aria-haspopup="true">
							<a href="{{route('superadmin.schedule-graph')}}" class="m-menu__link ">
								<i class="m-menu__link-icon flaticon-dashboard"></i>
								<span class="m-menu__link-title">
									<span class="m-menu__link-wrap">
										<span class="m-menu__link-text">Scheduling Graph</span>
									</span>
								</span>
							</a>
						</li>
