			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<li class="m-portlet__nav-item">
						<a href="{{route('superadmin.powerplant.create')}}" class="btn btn-focus m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
							<span>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#m_table_1').DataTable({
			...
			serverSide: true,
			ajax:{
				url:"{{ route('superadmin.powerplant.index') }}",
				data: function (d) {
		...
		$(document).on('click', '.change-status', function (e) {
			...
			if(value == 'Y'){
				var text = 'Are you sure you want to de-activate this tag?.';
			}else{
				var text = 'Are you sure you want to activate this tag.';
			}
